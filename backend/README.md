...
## Project Structure
    ...
    ├── testapiautostoryboa_85484  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_85484`
...
2. Clone this repo and `cd testapiautostoryboa_85484`
